...
public class WhenHandlingVacancyClosingSoon
{
        ...
        VacancyClosingSoonHandler sut)
    {
        ...
        findApprenticeshipJobsService.Setup(x => x.GetLiveVacancies(It.IsAny<int>(), 200, dateTime.AddDays(2))).ReturnsAsync(liveVacanciesApiResponse);
        ...
        {
            findApprenticeshipJobsService.Verify(x => x.GetLiveVacancies(It.IsAny<int>(), 200, dateTime.AddDays(2)), Times.Exactly(liveVacanciesApiResponse.TotalPages));
        }
    ...
    public async Task Then_LiveVacancies_Is_Null_Empty_List_Returned(
        ...
        VacancyClosingSoonHandler sut)
    {
        findApprenticeshipJobsService.Setup(x => x.GetLiveVacancies(It.IsAny<int>(), 200, It.IsAny<DateTime>())).ReturnsAsync(() => null);
