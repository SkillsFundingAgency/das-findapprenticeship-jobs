...
public class WhenHandlingVacancyApprovedEvent
{
        ...
        VacancyApprovedHandler sut)
    {
        ...
        findApprenticeshipJobsService.Setup(x => x.GetLiveVacancy(vacancyApprovedEvent.VacancyReference.ToShortString())).ReturnsAsync(liveVacancy);
        ...
        VacancyApprovedHandler sut)
    {
        ...
        findApprenticeshipJobsService.Setup(x => x.GetLiveVacancy(vacancyApprovedEvent.VacancyReference.ToShortString()))
